...
public class AdjacencyMatrixGraph<E extends Edge> implements Graph<E> {
	...
	protected boolean adjacencyOfEdgeDoesExist(int tailVertex, int headVertex) {
		return (this.adjacencyOfEdge(tailVertex, headVertex) != AdjacencyMatrixGraph.EDGE_NONE);
	}
	...
	private void setAdjacencyOfEdgeAExist(int tailVertex, int headVertex) {
		this.setAdjacencyOfEdgeAs(tailVertex, headVertex, AdjacencyMatrixGraph.EDGE_EXIST);
	}

	protected void setAdjacencyOfEdgeAsNone(int tailVertex, int headVertex) {
		this.setAdjacencyOfEdgeAs(tailVertex, headVertex, AdjacencyMatrixGraph.EDGE_NONE);
	}
