...
public class WeightedUndirectedAdjacencyListGraph <WE extends WeightedEdge> extends UndirectedAdjacencyMatrixGraph<WE> implements SupplementForWeightedGraph<WE> {
	...
	private void setWeightOfEdgeAsNone(int aTailVertex,int aHeadVertex) {
		this.setWeightedOfEdge(aTailVertex, aHeadVertex, WeightedUndirectedAdjacencyListGraph.WEIGHTED_EDGE_NONE);
	}
	
	public WeightedUndirectedAdjacencyListGraph(int givenNumberOfVertices) {
	...
	public int weightOfEdge(WE anEdge) {
		...
		return WeightedUndirectedAdjacencyListGraph.WEIGHTED_EDGE_NONE;
	}
	@Override
	...
	protected boolean adjacencyOfEdgeDoesExist(int aTailVertex,int aHeadVertex) {
		return(this.adjacencyOfEdge(aTailVertex, aHeadVertex)!=WeightedUndirectedAdjacencyListGraph.WEIGHTED_EDGE_NONE);
	}
	@Override
