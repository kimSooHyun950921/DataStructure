...
public class WeightedDirectedAdjacencyListGraph<WE extends WeightedEdge> extends DirectedAdjacencyListGraph<WE> implements SupplementForWeightedGraph<WE>{
	private static final int WEIGHTED_INFIITE = Integer.MAX_VALUE/2;
	...
	public int weightOfEdge(WE anEdge) {
		...
		return WeightedDirectedAdjacencyListGraph.WEIGHTED_INFIITE;
	}
	@Override
	...
	public boolean edgeDoesExist(int aTailVertex, int aHeadVertex) {
		if(this.edgeIsValid(aTailVertex,aHeadVertex)) {
			return(this.adjacencyOfEdge(aTailVertex, aHeadVertex)<
					WeightedDirectedAdjacencyListGraph.WEIGHTED_INFIITE);
		}
		return false;
	}
